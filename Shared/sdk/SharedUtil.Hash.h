...
namespace SharedUtil
{
    ...
    SString ConvertDataToHexString(const void* pData, std::uint32_t uiLength);
    void    ConvertHexStringToData(const SString& strString, void* pOutData, std::uint32_t uiLength);
    void    GenerateSha256(const void* pData, std::uint32_t uiLength, std::uint8_t output[32]);
    SString GenerateSha256HexString(const void* pData, std::uint32_t uiLength);
    SString GenerateSha256HexString(const SString& strData);
    SString GenerateSha256HexStringFromFile(const SString& strFilename);
    SString GenerateHashHexString(EHashFunctionType hashFunction, const void* pData, std::uint32_t uiLength);
