...
namespace SharedUtil
{
...
#else
    inline void OutputDebugLineDummy() noexcept {}
    inline void SetDebugTagHiddenDummy() noexcept {}
    inline bool IsDebugTagHiddenDummy() noexcept { return false; }
    ...
    void CycleFile(const SString& strPathFilename, std::uint32_t uiCycleThreshKB = 1, std::uint32_t uiNumBackups = 1);
};            // namespace SharedUtil
