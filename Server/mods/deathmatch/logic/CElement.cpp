...
// Static function
std::uint32_t CElement::GetTypeHashFromString(const SString& strTypeName)
{
    ...
    std::uint32_t uiTypeHash = HashString(strTypeName);
...
void CElement::GetDescendantsByTypeSlow(std::vector<CElement*>& outResult, std::uint32_t uiTypeHash)
{
