...
public:
    ...
    std::uint32_t GetMasterServerQueryCount() const noexcept { return m_ulMasterServerQueryCount; }
    std::uint32_t GetTotalQueryCount() const noexcept { return m_uiNumQueriesTotal; }
    std::uint32_t GetQueriesPerMinute() const noexcept { return m_uiNumQueriesPerMinute; }
