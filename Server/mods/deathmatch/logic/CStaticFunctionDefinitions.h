...
public:
    ...
    static bool TriggerLatentClientEvent(const std::vector<CPlayer*>& sendList, const char* szName, CElement* pCallWithElement, CLuaArguments& Arguments,
                                         int iBandwidth, CLuaMain* pLuaMain, std::uint16_t usResourceNetId);
    ...
    static const std::string& GetPlayerSerial(CPlayer* pPlayer, std::uint32_t uiIndex);
    ...
    static bool TakePlayerScreenShot(CElement* pElement, std::uint32_t uiSizeX, std::uint32_t uiSizeY, const SString& strTag, std::uint32_t uiQuality, std::uint32_t uiMaxBandwidth,
                                     std::uint32_t uiMaxPacketSize, CResource* pResource);
    ...
    static bool GetColPolygonPointPosition(CColPolygon* pColPolygon, std::uint32_t uiPointIndex, CVector2D& vecPoint);
    ...
    static bool SetColPolygonPointPosition(CColPolygon* pColPolygon, std::uint32_t uiPointIndex, const CVector2D& vecPoint);

    static bool AddColPolygonPoint(CColPolygon* pColPolygon, const CVector2D& vecPoint);
    static bool AddColPolygonPoint(CColPolygon* pColPolygon, std::uint32_t uiPointIndex, const CVector2D& vecPoint);
    static bool RemoveColPolygonPoint(CColPolygon* pColPolygon, std::uint32_t uiPointIndex);
