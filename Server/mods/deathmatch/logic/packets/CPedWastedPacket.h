...
public:
    ...
    CPedWastedPacket(CPed* pPed, CElement* pKiller, std::uint8_t ucKillerWeapon,
        std::uint8_t ucBodyPart, bool bStealth, AssocGroupId animGroup = 0, AnimationId animID = 15) noexcept;
