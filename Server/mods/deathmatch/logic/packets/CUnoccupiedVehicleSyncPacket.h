...
public:
    ...
    const std::vector<SyncData>::const_iterator cbegin() const noexcept { return m_Syncs.cbegin(); }
    const std::vector<SyncData>::const_iterator cend() const noexcept { return m_Syncs.cend(); }
